        ...
        <div class="card card-tabs">
            <div class="card-header p-0 pt-1">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="pill" href="#changed_items" role="tab">Changed Items</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="card-body table-responsive">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="changed_items" role="tabpanel">
                        <table id="item_change_list" class="table table-bordered table-striped" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Sale Date</th>
                                    <th>Sale Number</th>
...
@section('js')
    ...
    $(document).ready(function() {
        $(document).on('submit', '.void_change_form', function () {
        ...
        $('#item_change_list').DataTable({
            "order": [7, 'desc'],
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('change.getAllChanges') }}",
            columns: [
                ...
                {data: 'created_at'},
                {data: 'change_number'},
                {data: 'returnedItems', searchable: false},
                {data: 'changedItems', searchable: false},
                {data: 'user.name'},
        ...
        $('#all_branches_sales_list').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('sale.getAllBranchesSales', 'changes') }}",
            columns: [
